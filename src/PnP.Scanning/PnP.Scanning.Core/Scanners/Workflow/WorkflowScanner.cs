                        ...
                        if (siteWorkflowSubscriptions.Any())
                        {
                            foreach (var siteWorkflowSubscription in siteWorkflowSubscriptions)
                            {
                                ...
                                workflowLists.Add(new Workflow
                                {
                                    ...
                                    DefinitionName = Clean(siteDefinition.DisplayName),
                                    DefinitionDescription = Clean(siteDefinition.Description),
                                    SubscriptionName = Clean(siteWorkflowSubscription.Name),
                        ...
                        if (listWorkflowSubscriptions.Any())
                        {
                            foreach (var listWorkflowSubscription in listWorkflowSubscriptions)
                            {
                                ...
                                workflowLists.Add(new Workflow
                                {
                                    ...
                                    ContentTypeName = Clean(associatedContentTypeName),
                                    Scope = "List",
                                    RestrictToType = listDefinition.RestrictToType,
                                    DefinitionName = Clean(listDefinition.DisplayName),
                                    DefinitionDescription = Clean(listDefinition.Description),
                                    SubscriptionName = Clean(listWorkflowSubscription.Name),
                                    HasSubscriptions = true,
