        ...
        RawDiscoveryRecord record, SqliteTransaction transaction)
    {
        ...
        Execute(transaction, """
            ...
            ON CONFLICT(RunId, CanonicalInventoryKey) DO UPDATE SET
              ...
              PhysicalLocator=COALESCE(excluded.PhysicalLocator, DiscoveryInventory.PhysicalLocator),
              FileName=excluded.FileName,
              PermissionContext=COALESCE(excluded.PermissionContext, DiscoveryInventory.PermissionContext),
              DiscoveryState=excluded.DiscoveryState,
              StableSourceObjectKey=COALESCE(excluded.StableSourceObjectKey, DiscoveryInventory.StableSourceObjectKey),
              SiteCollectionId=COALESCE(excluded.SiteCollectionId, DiscoveryInventory.SiteCollectionId),
              WebId=COALESCE(excluded.WebId, DiscoveryInventory.WebId),
              ListId=COALESCE(excluded.ListId, DiscoveryInventory.ListId),
              FolderUniqueId=COALESCE(excluded.FolderUniqueId, DiscoveryInventory.FolderUniqueId),
              ListItemId=COALESCE(excluded.ListItemId, DiscoveryInventory.ListItemId),
              FileUniqueId=COALESCE(excluded.FileUniqueId, DiscoveryInventory.FileUniqueId),
              HomePage=COALESCE(excluded.HomePage, DiscoveryInventory.HomePage),
              ContentTypeId=COALESCE(excluded.ContentTypeId, DiscoveryInventory.ContentTypeId),
              PageType=COALESCE(excluded.PageType, DiscoveryInventory.PageType),
              LibraryHidden=COALESCE(excluded.LibraryHidden, DiscoveryInventory.LibraryHidden),
              CustomizedPageStatusRaw=COALESCE(excluded.CustomizedPageStatusRaw, DiscoveryInventory.CustomizedPageStatusRaw),
              ObservationMethod=COALESCE(excluded.ObservationMethod, DiscoveryInventory.ObservationMethod),
              SelectionState=COALESCE(excluded.SelectionState, DiscoveryInventory.SelectionState),
              WelcomePageStatus=COALESCE(excluded.WelcomePageStatus, DiscoveryInventory.WelcomePageStatus),
              ScanId=COALESCE(excluded.ScanId, DiscoveryInventory.ScanId),
              SiteUrl=COALESCE(excluded.SiteUrl, DiscoveryInventory.SiteUrl),
              WebUrl=COALESCE(excluded.WebUrl, DiscoveryInventory.WebUrl),
