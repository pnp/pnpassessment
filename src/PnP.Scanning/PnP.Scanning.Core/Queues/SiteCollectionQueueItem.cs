...
namespace PnP.Scanning.Core.Queues
{
    ...
    {
        internal SiteCollectionQueueItem(OptionsBase optionsBase, IPnPContextFactory pnPContextFactory, string siteCollectionUrl) : 
            base(optionsBase, pnPContextFactory)
        {
