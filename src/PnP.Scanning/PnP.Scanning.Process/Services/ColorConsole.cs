...
namespace PnP.Scanning.Process.Services
{
    ...
    {
        internal static int MaxWidth { get; } = 80;
        ...
        internal static void WriteLine(string text, ConsoleColor? color = null)
        {
            if (color.HasValue)
            {
        ...
        /// <param name="text"></param>
        /// <param name="color"></param>
        internal static void Write(string text, ConsoleColor? color = null)
        {
            if (color.HasValue)
            {
                var oldColor = Console.ForegroundColor;
        ...
        /// <param name="text">Text to write</param>
        /// <param name="color">A console color. Must match ConsoleColors collection names (case insensitive)</param>
        internal static void Write(string text, string color)
        {
            if (string.IsNullOrEmpty(color))
            {
                Write(text);
        ...
        internal static void WriteWrappedHeader(string headerText,
                                                char wrapperChar = '-',
        ...
        internal static void WriteEmbeddedColorLine(string text, ConsoleColor? baseTextColor = null)
        {
